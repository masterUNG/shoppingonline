...
class AppConstant {
  ...
  static List<String> paymentMethods = <String>[
    'Cash Delivery',
    'Mobile Banking',
    'Credit Card',
    'PromptPay QR Code'
  ...
  static String signInDescrip =
      'เข้าสู่ระบบเพื่อประสบการณ์ที่ดีกว่า! ช้อปง่าย ขายสะดวก รับดีลสุดพิเศษก่อนใคร มั่นใจทุกการซื้อขาย ปลอดภัย 100% โหลดเลย!';
